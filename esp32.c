...
String myToken = "7105939186:AAEWjj9mXq_oOREkGJzN_OZS-8NsDDuX_7s" ;   // Create your bot and get the token -> https://telegram.me/fatherbot
String myChatId = "5364601961";   // Get chat_id -> https://telegram.me/chatid_echo_bot
#include <WiFi.h>
...
int sensorPin = 13;   //sound Motion Sensor
...
void setup() 
{
 ...
 pinMode(4, OUTPUT);
  ...
  sendMessage2Telegram(myToken, myChatId, "Hello cam");
  ...
  int sensorData = digitalRead(sensorPin);
   if (sensorData == HIGH) {
    ...
    // the clap is detected and not due to any spurious sounds
      ...
      digitalWrite(4, HIGH);  
       sendMessage2Telegram(myToken, myChatId, "UNAUTHORISED ENTRY");
       sendCapturedImage2Telegram(myToken, myChatId);
    }
    else{
       digitalWrite(4, LOW);  
